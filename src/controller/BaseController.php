...
class BaseController {
    ...
    /*
     * Quand j'instancie une class Controller (Home, Membre, Post) ma fonction __construct s'éxècute automatiquement
     */
    public function __construct()
    {
        ...
        // Je créer une nouvelle instance de Twig_Environment et j'envoie en argument 1 le $loader et en argument 2 un tableau de configuration indiquant
        // que l'on ne veut pas de cache et que l'on est en debug
        ...
        // Ajout de l'extension text dans mon twig
